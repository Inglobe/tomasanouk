	...
	jQuery(window).bind('load resize',function(){
		  ...
		  if ( sw > 768 ) {
				jQuery(window).scroll(function () {
				 	sh = jQuery('.header-container').height();
				    if (jQuery(this).scrollTop() > sh + 40) {
				     jQuery('.nav-container ').addClass('nav-container-fixed');
				      jQuery('.page').addClass('indent-container');
				    } else {
				     jQuery('.nav-container').removeClass('nav-container-fixed');
				     jQuery('.page').removeClass('indent-container');
				    } 
				  });
		  } else { 
			   jQuery('.nav-container').removeClass('nav-container-fixed');
			   jQuery('nav-container-fixed').removeAttr('style');
		  };
	});
